...
//++++++++++++++++++++++++++
strcpy(cIpAddr, "192.168.1.1");//TODO: r.!
...
/*
			...
			{
				printf("%s\n[SUCCESS] Tocken: %d; retieved: %d\n", RespStr.cpResponce, iTocken,	RespStr.iSize);

				//break;
				return SUCCESS;
			}
			else
				if ((101 == RespStr.iSize) && ('1'==RespStr.cpResponce[55] && '0'==RespStr.cpResponce[56] &&'0'==RespStr.cpResponce[57] &&'3'==RespStr.cpResponce[58] &&'0'==RespStr.cpResponce[59] && '2'==RespStr.cpResponce[60] ) )
				{
